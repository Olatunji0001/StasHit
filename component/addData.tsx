      ...
      if (Object.keys(data).length > 0) {
        try {
          ...
          const res = await axios.put(
            `http://localhost:1300/edit-data/${id}`,
            {
    ...
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        <div className="mx-auto mb-4">
          <div className="bg-gradient-to-r from-amber-500 to-amber-600 w-16 h-16 flex items-center justify-center rounded-2xl shadow-sm mx-auto">
            <FiUser className="text-white text-2xl" />
          </div>
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Add New Contact</h1>
        <p className="text-gray-600 text-sm">Save your important contacts securely</p>
      </div>
